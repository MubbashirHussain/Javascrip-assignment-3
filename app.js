...
var Username;
var myname = " Mubbashir Hussain";
var message = " Hello world";
alert(message);

var StudentBio = myname + '\n i am 20year old' +"\n doing Course for Web development"
alert(StudentBio)

var pizza = "pizza" + "\npizz" + '\nPiz' + "\nPi" + "\nP" 
alert(pizza)

var email = "Mubbashirhhussain@gmail.com"
 alert("My Email Address is : " + email)

var book = "' A smarter way to learn JavaScript '"
alert("I am learn from the book  :  " + book )

document.write("Yah! I can Write HTML contect Thorugh JAVASCRIPT" + "<br><br>")
...
var viewCount = 15 ;
alert("You have Visited this page "+viewCount+" times")

var BirthDate = 2003
document.write("My birth Year is " + BirthDate +"<br>" + "Data type of my Brith Date var is Number" + "<br><br>")

var StoreLink = "https://www.xyzclothing.com"
document.write("<b>John Doe</b> ordered <b>5 T-shirt(s) </b> on "+ "<a>"+StoreLink+"</a> "+"<br><br>")
...
var userName  = prompt("Enter your user name" , "Mubbashir");

document.write("<br>"+"Hello " + userName + " Wellcome to our Website"+"<br>");

var whichTable =+prompt('Enter a Table Nunber which one You want' , "7") ;
...
var EnglishMarks  = +prompt('Enter you Obtained Mark of English' , '59')
var UrduMarks  = +prompt('Enter you Obtained Mark of Urdu','87')
var MathsMarks  = +prompt('Enter you Obtained Mark of Math','91')
var TotalMarksForAllsubject = 100;

document.write("<h2> Subject total marks Obtained Marks Percentage </h2> <br>");
document.write("English  100  into " + EnglishMarks +" :  per "+ (EnglishMarks * 100 /  TotalMarksForAllsubject)+"% <br>"  );
document.write("English  100  into " + UrduMarks +" :  per "+ (UrduMarks * 100 /  TotalMarksForAllsubject)+"% <br>"  );
document.write("English  100  into " + MathsMarks +" :  per "+ (MathsMarks * 100 /  TotalMarksForAllsubject)+"% <br>"  );
var TotalMarksObtained = EnglishMarks + UrduMarks + MathsMarks ; 
...
var User_gender = prompt("Enter your Gender Male Or Female ? ","male");
...
var User_input_ligth = prompt("Enter signal  light color " ,"green");

if( User_input_ligth == "red"){
    document.write("<h4 style='color: red'>Must Stop</h4>")
}else if( User_input_ligth == "yellow"){
    document.write("<h4  style='color: yellow'>Ready to move</h4>")
}else if( User_input_ligth == "green"){
...
var TODayS_temp = +prompt("Enter temperature " , "31");

if(TODayS_temp > 40){
    document.write("It is too hot <b>Out</b>side.<br><br>")
}else if(TODayS_temp >= 30){
    document.write("The Weather today is Normal.<br><br>")
}else if(TODayS_temp >= 20){
    document.write("Today’s Weather is cool.<br><br>")
}else if(TODayS_temp >= 10){
    document.write("OMG! Today’s weather is so Cool.<br><br>")
}

var First_number_Cal = +prompt("Enter First Number To Calulate","25");
var Operatio_Cal = prompt(" (' + , - , * , / , % ') ?" ,'/')
var Second_number_Cal = +prompt("Enter Second Number To Calulate","10");

if(Operatio_Cal == "*"){
    document.write(First_number_Cal +" * " + Second_number_Cal +" = "+ (First_number_Cal * Second_number_Cal) + "<br><br>")
}else if(Operatio_Cal == "+"){
    document.write(First_number_Cal +" + " + Second_number_Cal +" = "+ (First_number_Cal + Second_number_Cal) + "<br><br>")
}else if(Operatio_Cal == "-"){
    document.write(First_number_Cal +" - " + Second_number_Cal +" = "+ (First_number_Cal - Second_number_Cal) + "<br><br>")
}else if(Operatio_Cal == "/"){
...
var vowel = prompt("Enter Any Vowel It return True Overwise False", "e")
...
Color_Array[Which_index_user_want] = What_color_Add_at_index ;
document.write(Color_Array + "<br>")
...
Color_Array.splice(WhichIndex_you_want , How_much_color_uwant_to_delete)
document.write(Color_Array + "<br><br>")
...
var Loop_table_length = +prompt("Enter a Table legnth which you want Table Run",'11');;
...
var Baker_itme = prompt("welcome to our bakery, what do want to Order sir/Ma'am ?", "cookie");

var bakery_flag = false;

for (var i = 0; i < Bakers.length; i++) {
    if (Bakers[i] == Baker_itme) {
        alert(Bakers[i]+" Is available at index "+(i) +" in our bakery");
        bakery_flag = true

    }
}
bakery_flag = (!bakery_flag) ? alert("We are Sorry to you '"+Baker_itme+"' is Not Available in our bakery") : bakery_flag
